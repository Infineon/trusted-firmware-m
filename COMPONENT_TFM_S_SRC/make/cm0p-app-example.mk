...
# Enable build of secure tests
ifeq ($(TFM_BUILD_S_TEST),true)
TFM_CONFIGURE_EXT_OPTIONS+= -DTEST_S:BOOL=ON -DNS:BOOL=ON
endif
...
# Handle getlibs
_MTB_TOOLS__EXECUTE_GETLIBS+= && $(MAKE) tfm-download

# Include TF-M Makefile
ifneq ($(wildcard $(SEARCH_trusted-firmware-m)/COMPONENT_TFM_S_SRC/make/tfm.mk),)
include $(SEARCH_trusted-firmware-m)/COMPONENT_TFM_S_SRC/make/tfm.mk
endif
